...
$routes->group('admin', ['filter' => 'role:admin'], function ($routes) {
    ...
    $routes->post('others-options/edit/(:num)',        'Admin\OthersOptions::edit/$1');
    $routes->post('others-options/deactivate/(:num)', 'Admin\OthersOptions::deactivate/$1');
    $routes->post('others-options/activate/(:num)',   'Admin\OthersOptions::activate/$1');
