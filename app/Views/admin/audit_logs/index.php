...
<div class="vs-page-header mb-4">
    ...
    <div class="vs-card">
        <div class="vs-card-body">
            <table id="adminAuditLogsTable" class="vs-datatable js-data-table vs-mobile-primary" data-mobile-primary="4" data-page-search="customAuditSearch" data-search-placeholder="Search audit logs..." data-col-defs='[{"className":"text-start","targets":[2,3]},{"className":"text-center","targets":[0,1,4]}]' style="width:100%">
                <thead>
                    <tr>
